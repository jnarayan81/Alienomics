...
my $idba_f = "ftp://ftp.ncbi.nlm.nih.gov/blast/executables/LATEST/ncbi-blast-2.6.0+-x64-linux.tar.gz;";
my $hmmer_f = "http://bioinf.uni-greifswald.de/augustus/binaries/augustus-3.2.3.tar.gz";
my $frag_f = "ftp://ftp.ncbi.nlm.nih.gov/blast/db/nt.*.tar.gz";
my $bowtie_f = "ftp://ftp.ncbi.nlm.nih.gov/pub/taxonomy/taxdump.tar.gz";
my $idba_dir = "https://www.arb-silva.de/fileadmin/silva_databases/release_128/Exports/SILVA_128_LSUParc_tax_silva.fasta.gz";
my $hmmer_dir = "https://downloads.sourceforge.net/project/bio-bwa/bwakit/bwakit-0.7.12_x64-linux.tar.bz2";
